...
4. MULTILINGUAL RESPONSE RULE: Detect the language of the patient's message (Hindi, Spanish, French, German, Marathi, Tamil, Telugu, etc.) and ALWAYS respond in the EXACT SAME language used by the patient.
5. Respond only when explicitly prompted.
"""
